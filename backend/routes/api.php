...
Route::prefix('migration')->group(function () {
    ...
    Route::post('download-from-url', [\App\Http\Controllers\Api\MigrationController::class, 'downloadFromUrl']);
    Route::get('status',             [\App\Http\Controllers\Api\MigrationController::class, 'status']);
