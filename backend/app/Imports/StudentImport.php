...
class StudentImport implements ToModel, WithHeadingRow, WithValidation, SkipsOnError, WithBatchInserts, WithChunkReading
{
    use SkipsErrors;
    ...
    public function model(array $row): ?Student
    {
        ...
        $validStatuses = ['Aktif', 'Cuti', 'Lulus', 'DO', 'Mengundurkan Diri'];
        $status = in_array($row['status'] ?? '', $validStatuses) ? $row['status'] : 'Aktif';
